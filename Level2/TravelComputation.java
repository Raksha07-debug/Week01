...
System.out.println("enter time taken  from timeFromToVia");
int timeTaken=sc.nextInt();
      int timeFromToVia = 4 * 60 +timeTaken;
...
System.out.println("enter time taken  from timeViaToFinalCity");
int timeTakenToFinalCity=sc.nextInt();


      int timeViaToFinalCity = 4 * 60 +  timeTakenToFinalCity;
